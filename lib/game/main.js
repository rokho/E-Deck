...
ig.soundManager; // not sure if this is how and where to implement the sound manager.
ig.music.add('dropbox/E-deck/sound assets/BGM2.ogg'); //not sure if we need to code in both the ogg and the MP3 fiile extensions.
ig.music.loop = true;
ig.music.volume = 0.5;
ig.music.play();
